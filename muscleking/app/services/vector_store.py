...
class VectorStore:
    ...
    def add_documents(
        ...
        try:
            ...
            entities = [
                ...
                embeddings,
                contents,
                [metadata.get("exercise_id","") for metadata in metadatas],  # exercise_id即父文档id
    ...
    def search(
        ...
        try:
            ...
            logger.info(f"Successfully searched {len(formatted_results)} documents in collection {self.collection_name}")
