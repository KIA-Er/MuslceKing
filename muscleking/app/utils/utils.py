...
def _format_exercise_schema_from_docs() -> str:
    ...
    if node_rows:
        summary_lines.append("exercise KG node types:")
    ...
    if relationship_rows:
        ...
        summary_lines.append("exercise KG relationship types:")
...
def retrieve_and_parse_schema_from_graph_for_prompts(graph: Neo4jGraph) -> str:
    ...
    it with curated information from docs/exercise_kg_schema.md.
    """
    ...
    doc_summary = _format_exercise_schema_from_docs()
    if doc_summary:
